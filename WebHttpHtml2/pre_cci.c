# 1 "c:\\lrs\\webhttphtml2\\\\combined_WebHttpHtml2.c"
...
# 1 "c:\\lrs\\webhttphtml2\\\\combined_WebHttpHtml2.c" 2
...
# 2 "c:\\lrs\\webhttphtml2\\\\combined_WebHttpHtml2.c" 2
...
# 3 "c:\\lrs\\webhttphtml2\\\\combined_WebHttpHtml2.c" 2
...
# 4 "c:\\lrs\\webhttphtml2\\\\combined_WebHttpHtml2.c" 2
...
# 1 "C:\\Program Files (x86)\\HP\\LoadRunner\\include/string.h" 1
...
# 10 "C:\\Program Files (x86)\\HP\\LoadRunner\\include/string.h" 2
...
Action()
{
	...
	lr_end_transaction("First_Trans", 2);
...
lr_start_transaction("CGI");
	...
	lr_end_transaction("Trans_other", 2);
	

	for(i = 0; i < 8; i++)
	{
		char buf[12];
		sprintf(buf, "transTes_%d", i);  
...
# 5 "c:\\lrs\\webhttphtml2\\\\combined_WebHttpHtml2.c" 2
...
# 6 "c:\\lrs\\webhttphtml2\\\\combined_WebHttpHtml2.c" 2
