node('Win10') {
	...
	echo sc3_path
	lrScenarioLoad controllerRunPollingInterval: '15', ignoreErrorStrings: '', perScenarioRunTimeOut: '15', fsTimeout: '900', testPaths: sc3_path
	}
	
    stage('Run performance test - sc1.lrs'){
	def sc1_path = pwd() + "\\sc1.lrs"
	echo sc1_path
	lrScenarioLoad controllerRunPollingInterval: '15', ignoreErrorStrings: '', perScenarioRunTimeOut: '15', fsTimeout: '900', testPaths: sc1_path
	}
